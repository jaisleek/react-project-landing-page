...
const tabsData = [
  {
    ...
    subtitle: 'SleekTutor puts the power of code into a visual canvas so every team can create stunning websites quickly — and extend the power of their work with custom code.',
    ...
    <section className="overflow-hidden py-24 bg-black">
      <div className=" container mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        ...
        <div className='flex flex-col justify-between gap-16'>
            ...
            Rethink the web dev cycle with SleekTutor. Give your design and marketing teams the power to launch sophisticated sites quickly — so your dev team can focus on more complex work, not pixel-perfect revisions.
          </p>
          <Link 
            to="/dashboard/signup"
