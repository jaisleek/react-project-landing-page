...
const features = [
  {
    ...
    description:
      "Whether you're trying to build even faster or you're just new to SleekTutor, you can use AI Assistant to generate new page sections using your site's existing design system.",
  ...
  {
    id: "ai-2",
    title: "Generate text right within Sleektutor",
    description:
      "Quickly and easily create new content, natively within SleekTutor. From generating first-pass content to publishing at speed, the AI Assistant can help you develop variations with just a few clicks.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-32  gap-8">
          ...
          <div className="mb-24">
            <p className="text-xl text-gray-300 mb-8 max-w-[35rem]">
              ...
              AI — directly in SleekTutor, then publish with a click.Easily
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-32 gap-8">
          ...
          <div>
            ...
            <div className="md:mb-28 mb-16 md:h-72 border-b border-white/10 pb-16">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-[35rem]">
                sleektutor's AI tools elevate your web projects through
